...
function relativeTimeWithPlural(number: string | number, withoutSuffix: any, key: string) {
  const format: any = {
...
const months = (dayjsInstance: any, format: any) => {
...
const monthsShort = (dayjsInstance: any, format: any) => {
  if (MONTHS_IN_FORMAT.test(format)) {
